 ...
 * @type {Serializer}
 */
var serialize = Serializer().transformMarkedRange(MARKS.STRIKETHROUGH, function (state, text) {
    return '~~' + text + '~~';
});
