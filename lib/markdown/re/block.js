...
block.paragraph = replace(block.paragraph)('hr', block.hr)('video', block.video)('heading', heading.normal)('lheading', heading.line)('blockquote', block.blockquote)('tag', '<' + _tag)('def', block.def)('math', block.math)('customBlock', block.customBlock)('comment', block.comment)('table', table.normal)('tablenp', table.nptable)();
