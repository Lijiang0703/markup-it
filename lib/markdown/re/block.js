...
var _tag = '(?!(?:' + 'a|em|strong|small|s|cite|q|dfn|abbr|data|time|code' + '|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo' + '|span|br|wbr|ins|del|img|video)\\b)\\w+(?!:\\/|[^\\w\\s@]*@)\\b';
...
block.paragraph = replace(block.paragraph)('hr', block.hr)('heading', heading.normal)('lheading', heading.line)('blockquote', block.blockquote)('tag', '<' + _tag)('def', block.def)('math', block.math)('customBlock', block.customBlock)('comment', block.comment)('table', table.normal)('tablenp', table.nptable)();

block.paragraph = replace(block.paragraph)('(?!', '(?!' + block.fences.source.replace('\\1', '\\2') + '|' + block.list.block_ol.source.replace('\\1', '\\3') + '|')();
